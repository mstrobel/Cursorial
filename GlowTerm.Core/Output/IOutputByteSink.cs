...
/// to <see cref="GlowTerm.Core.Input.IInputByteSource"/>. Used by anything that emits VT
/// sequences: capability negotiation, rendering, cursor manipulation, OSC requests.
/// </summary>
/// <remarks>
/// <para>
/// As with <see cref="GlowTerm.Core.Input.IInputByteSource"/>, not every output channel goes
