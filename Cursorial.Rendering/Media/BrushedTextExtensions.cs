...
public static class BrushedTextExtensions
{
    ...
    /// <see cref="DeclarationScope"/>), winning over any document-level brush. <paramref name="legacyBaseStyle"/>
    ...
    public static RichTextBuilder BrushedRun(this RichTextBuilder builder, string text, ScopedBrush brushed,
                                             CellStyle legacyBaseStyle = default)
    {
        ArgumentNullException.ThrowIfNull(builder);
        return builder.Run(text, legacyBaseStyle, tag: brushed);
    }
}
