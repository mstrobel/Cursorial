...
| **`Cursorial.UI`** | — Not started | Widget tree, layout, focus management, input routing. | Possible future layer on top of `Cursorial.Rendering`. Work has not yet commenced. |
