...
/// <summary>
/// The context menu KeyTip host (keytips-design §6): one badge per <see cref="MenuItem"/>. A header with a
...
/// </summary>
internal sealed class ContextMenuKeyTipHost(ContextMenu menu) : IKeyTipHost
{
    /// <inheritdoc/>
