...
public sealed class ColorPalette : IColorPalette
{
    ...
    private static readonly string[] HexCodes =
    [
    ...
    private static ColorPalette BuildPalette(int size)
    {
        if (size is < 0 or > 256)
        ...
        for (int i = 0; i < size; i++)
            palette[i] = Color.FromHex(HexCodes[i]);
    ...
    public static readonly ColorPalette Ansi16 = BuildPalette(16);
    public static readonly ColorPalette Ansi256 = BuildPalette(256);
