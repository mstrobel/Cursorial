...
public class WelcomeViewModel : PageViewModel
{
    ...
    {
        var rtb = new RichTextBuilder(new PartialStyle { Background = Color.Transparent, UnderlineColor = Color.Transparent }, TextTrimming.CharacterEllipsis, WrapMode.NoWrap);
