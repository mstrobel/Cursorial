...
- **Focus has two looks, split by control family.** *Pick* controls (Button, CheckBox, RadioButton, list/menu/
  ...
  `Theme.BgBrush` text). *Text* controls (TextBox, editable ComboBox, Spinner, cell-edit) show focus as an
...
| `ThemeKeys` | role |
|---|---|
| `Theme.BgBrush` | page background; the reverse-video text color |
