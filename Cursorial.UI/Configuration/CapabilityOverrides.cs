...
public sealed record CapabilityOverrides
{
    ...
    /// <summary>
    /// Overrides <see cref="Cursorial.Input.Capabilities.MouseCapabilities.Motion" /> (the <c>caps-motion</c> hover
    /// axis).
    /// </summary>
    public CapabilityOverride MouseMotion { get; init; }

    /// <summary>
    /// Overrides <see cref="Cursorial.Input.Capabilities.ProtocolCapabilities.KittyKeyboardProtocol" /> (the
    /// <c>caps-kitty-keyboard</c> axis).
    /// </summary>
                                ...
                                Graphics = graphics with
                                           {
                                               ...
                                               ITerm2InlineImages =
                                               Resolve(ITerm2InlineImages, graphics.ITerm2InlineImages)
                                           }
                            },
                               ...
                               Protocol = protocol with
                                          {
                                              ...
                                              KittyKeyboardFlags =
                                              kittyKeyboard ? protocol.KittyKeyboardFlags : KittyKeyboardFlags.None
                                          }
                           }
               };
    }
